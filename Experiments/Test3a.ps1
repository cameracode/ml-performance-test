...
$Chart1 = $CSV | New-GoogleChart -XAxis Iteration -YAxis Response_Time -Title "Response Time in MS during 100 Iterations" -LegendLocation Right -ChartType LineSoft
...
$convert =  ConvertTo-Html -Head $Header -Body `
            ...
            "<div><center>Min Response Time: $measure_max ms</center></div>" +`
            "<div><center>Min Response Time: $measure_avg ms</center></div>") | Out-File $report_path -Encoding ASCII
